	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
				...
				<fieldset> 
					<div class="row">
						...
						<div class="col-xs-12 col-sm-10">
							...
							<input type="text" readonly="readonly" class="form-control" pattern="(\d{3})([\.])(\d{2})" id="inp_total_paybox" value="0.00" />
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal" onclick="confirm_sell()">
					Aceptar
				</button>
			</div>
		</div>
...
<script>
	function cash()
	{
		var total = $("#inp_total_paybox").val();
		var pay = $("#inp_pay").val();
		var cash = pay - total;
