			...
			<div class="contact-widget contact-widget-info">
				<div class="panel-body">
					<div class="col-lg-4 col-sm-4">
						<h4><?php echo $ttype->task_type; ?></h4>
					...
					<div class="col-lg-6 col-sm-6 follow-info">
						<div class="row">
							<span><i class="fa "></i>Numero de Actividades Asignadas</span>
						</div>
						
						<div class="row">
							<span><i class="fa "></i><strong><?php echo count($ttype->activities); ?></strong></span>
						</div>
								...
								<div class="panel-body bio-graph-info">
									...
									<div class="row ">
										<div class="col-xs-12 col-sm-12">
											<p><label class="col-xs-12">Actividades </label>  &nbsp; </p>
										</div>
									</div>
									...
									<div class="row ">
										<div class="col-xs-12 col-sm-12" style="max-height: 200px; overflow-y: scroll; ">
											<table id='tbl_task_type' class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php echo $ttype->get_activities_html(); ?>
												</tbody>
