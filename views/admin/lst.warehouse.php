...
$list = new AdminList( 'lst_warehouse' ); 
...
<div id="dashboard-header" class="row">
	<div class="col-xs-12 ">
		<h2> <i class="fa fa-thumb-tack"> </i> &nbsp; Bodega </h2> 
	</div>  
</div>
	...
	<div class="col-xs-12 col-sm-12">
		<div class='row-fluid'>  
			<div id="dashboard-overview" class="row" style=""> 
				<div class="col-xs-9">
					<h3 id='lbl_table_visits'> Inventario Bodega </h3> 
				</div>
					...
					<?php if ( $Session->is_admin() ){ ?> 
						...
						<div class="btn-group pull-right">
						  ...
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="#" title="Surtir Nuevo" onclick='supply_warehouse(0);' ><i class="fa fa-truck"></i> Surtir Nuevo </a></li>
						  	<li class="divider"></li>
