...
//$list 	 = new ProyectList( 'lst_pry_visit' );
require_once DIRECTORY_CLASS . "class.admin.lst.php";	
$list = new AdminList( 'lst_visit' ); 
...
<div id="dashboard-header" class="row">
	<div class="col-xs-12 ">
		<h2> <i class="fa fa-thumb-tack"> </i> &nbsp; Visitas </h2> 
	</div>  
</div>
	...
	<div class="col-xs-12 col-sm-12">
		<div class='row-fluid'>  
			<div id="dashboard-overview" class="row" style=""> 
				<div class="col-xs-9">
					<h3 id='lbl_table_visits'> Visitas </h3> 
				</div>
					...
					<?php if ( $Session->is_admin() ){ ?> 
						...
						<div class="btn-group pull-right">
						  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
						  	<i class="fa fa-plus"></i><span class='hidden-xs hidden-sm' >Crear Visitas</span> <span class="caret"></span>
						  </button>
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="#" title="Crear Visita" onclick='edit_visit(0);' > Crear Visita </a></li>
						  	<li class="divider"></li>
						    <li><a href="#" title="Importar Visitas" onclick='load_visits();' data-target="#mdl_upload_visit" data-toggle="modal">Importar Visitas</a></li> 
						    <li><a href="uploads/tmpl.visit_load.csv" title="Descargar Plantilla" target="_blank" > Descargar Plantilla </a></li>  
						  </ul>
						</div>
						<!--
